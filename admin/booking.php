    ...
    <main>
        ...
        <section class="menu">
            ...
            <header>            
                ...
                <div class="type"><h2>Бронирования</h2></div>
            ...
            <main>
                ...
                <? 
                    ...
                    $allbooking = mysqli_fetch_all ( mysqli_query($bd, "SELECT * FROM `bookings` WHERE `Status` LIKE 'Одобрено'"));
                ...
                <div class="booking-container">
                    ...
                    <?
                        ...
                        foreach ($allbooking as $allbooking) {
                            ...
                            ?>
                                <form action="../core/cancel.php" method="post">
